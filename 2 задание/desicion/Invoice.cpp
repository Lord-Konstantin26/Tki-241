...
const string& Invoice::getId() const { return id; }
const string& Invoice::getDate() const { return date; }
double Invoice::getTotalAmount() const { return totalAmount; }
Client* Invoice::getClient() const { return client; }
const vector<pair<Product*, int>>& Invoice::getSoldItems() const { return soldItems; }
